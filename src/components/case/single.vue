    ...
    <el-card>
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12" style="text-align:right">
          ...
          <el-button type="primary" @click="addDialogVisible = true">添加Case</el-button>
        </el-col>
      </el-row>
      ...
      <el-table :data="caseList" border height="670" style="width: 100%">
        ...
        <el-table-column prop="getParams" label="请求参数" width="500"></el-table-column>
        <!-- 请求头暂时不用 -->
    ...
    <el-dialog :close-on-click-modal="false"  title="用例添加" :visible.sync="addDialogVisible" width="50%" @close="closeAdd()">
      ...
      <el-form ref="addCaseFormRef" :rules="addFormRules" :model="addCaseForm" label-width="100px">
        ...
        <el-form-item
          ...
          prop="protocolId"
        >
          <el-select style="width:93%" v-model="addCaseForm.protocolId" placeholder="请选择协议">
            <el-option
              v-for="item in protocolsOptions"
              :key="item.value"
              :label="item.label"
        ...
        <el-form-item style="margin-left:150px;margin-right:150px" label="所属项目" prop="projectId">
          <el-select style="width:93%" v-model="addCaseForm.projectId" placeholder="请选择项目">
            <el-option
              v-for="item in projectOptions"
              :key="item.value"
              :label="item.label"
        ...
        <el-form-item v-if="addCaseForm.protocolId != 1 && addCaseForm.protocolId != 4 " style="margin-left:150px;margin-right:150px" label="请求参数" prop="getParams">
